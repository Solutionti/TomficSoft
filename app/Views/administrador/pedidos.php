...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    table.tbl tbody tr:nth-child(2) {
      animation-delay: .08s
    }

    table.tbl tbody tr:nth-child(3) {
      animation-delay: .11s
    }

    table.tbl tbody tr:nth-child(4) {
      animation-delay: .14s
    }

    table.tbl tbody tr:nth-child(5) {
      animation-delay: .17s
    }

    table.tbl tbody tr:nth-child(6) {
      animation-delay: .20s
    }

    table.tbl tbody tr:nth-child(7) {
      animation-delay: .23s
    }

    table.tbl tbody tr:nth-child(8) {
      animation-delay: .26s
    }

    table.tbl tbody tr:nth-child(9) {
      animation-delay: .29s
    }

    table.tbl tbody tr:nth-child(10) {
      animation-delay: .32s
    }
    ...
    .badge.a {
      ...
      color: var(--amber);
      border: 1px solid rgba(201, 124, 15, .22);
    }

    .badge.b {
      background: var(--blue-s);
      color: var(--blue);
      border: 1px solid rgba(26, 127, 212, .2);
    }

    .badge.r {
      background: var(--red-s);
      color: var(--red);
      border: 1px solid rgba(208, 51, 80, .2);
    }
    ...
    .act-btn.eye:hover {
      background: rgba(26, 127, 212, .18);
      box-shadow: 0 4px 12px var(--blue-s);
    }
  ...
  ══════════════════════════════════════════ */
    ...
    .feed-refresh.spinning i {
      animation: spin .45s cubic-bezier(.5, 0, .5, 1);
    }
                      ...
                      <tr>
                        <td>
                          <div class="acts">
                            ...
                            <button class="act-btn eye" onclick="verPedido('<?= $pedido->codigo_pedido ?>')"
                              title="Ver detalle"><i class="fas fa-eye"></i></button>
                            <a class="act-btn wa" target="_blank"
                              ...
                              title="Enviar WhatsApp"><i class="fab fa-whatsapp"></i></a>
                          </div>
                        </td>
...
══════════════════════════════════════ -->
  <div class="modal fade" id="verpedido" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="mpLabel"
    aria-hidden="true">
