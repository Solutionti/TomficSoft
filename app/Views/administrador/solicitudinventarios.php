    ...
    <div class="pos-left">
        <div class="pos-left-inner">
            ...
            <div class="pos-return-section" id="volver">
                ...
                <div class="pos-return-amount text-white" id="devolver">$0</div>
            </div>
    ...
    <div class="pos-right">
        ...
        <div class="pos-topbar">
            <div>
                ...
                <h4 class="">Solicitud de Inventarios</h4>
            </div>
                ...
                <tbody class="tbody">
                    ...
                    <tr id="emptyCartRow">
                        <td colspan="6" class="cart-empty">
                            ...
                            <span style="font-size:12px;color:var(--purple-300);">Agraga un producto para comenzar</span>
                        </td>
                    </tr>
                </tbody>
            </table>
