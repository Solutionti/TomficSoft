                      ...
                      <tr>
                        <td>
                          <div class="action-wrap">
                            <button class="btn-action btn-action-edit"
                              onclick="mostrarDatosUsuarioModal(<?= $usuario->codigo_usuario; ?>)" title="Editar usuario">
                              <i class="fas fa-pen"></i>
                            </button>
                            <button class="btn-action btn-action-del"
                              onclick="eliminarUsuario('<?= $usuario->codigo_usuario; ?>')" title="Eliminar usuario">
                        ...
                        <td>
                          <div class="user-cell">
                            <div class="user-avatar-wrap">
                              ...
                              <span
                                class="user-status-dot <?= $usuario->estado == 'Activo' ? 'dot-active' : 'dot-inactive' ?>"></span>
                            </div>
                            <div>
                        ...
                        <td>
                          ...
                          if ($rol == 'Administrador')
                            $rolClass = 'badge-amber-u';
                          elseif ($rol == 'Vendedor')
                            $rolClass = 'badge-success-u';
                          ?>
