            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-striped">
                        <thead >
                          <tr >
                            <th class="color-morado"> User </th>
                            <th class="color-morado"> First name </th>
                            <th class="color-morado"> Progress </th>
                            <th class="color-morado"> Amount </th>
                            <th class="color-morado"> Deadline </th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
